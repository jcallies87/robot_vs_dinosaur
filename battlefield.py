    ...
    def battle_phase(self):
        ...
        while epic_battle:
            if (self.dino.dinosaur_health >= 0) or (self.robot.robot_health >= 0):
                ...
                if self.dino.dinosaur_health >= 1:
                    ...
                    dino_lost = (f" {self.dino.dinosaur_name} has sustained {self.robot.battle_damage} damage points.{self.dino.dinosaur_name} has 0 damage points left.{self.robot.robot_name} is the winner!")
                    return dino_lost
                continue
